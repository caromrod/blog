...
const btnguardar = document.getElementById('btnguardarPoo');
const comentarioguardado = document.getElementById('ResultadoDComentariosPoo');
const cantDeComentarios = document.getElementById('cantDeComentariosPoo');
