...
const btnguardar = document.getElementById('btnguardarFunc');
const comentarioguardado = document.getElementById('ResultadoDComentariosFunc');
const cantDeComentarios = document.getElementById('cantDeComentariosFunc');
