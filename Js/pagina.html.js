...
const btnguardar = document.getElementById('btnguardarHtml');
const comentarioguardado = document.getElementById('ResultadoDComentariosHtml');
const cantDeComentarios = document.getElementById('cantDeComentariosHtml');
