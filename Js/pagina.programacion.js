...
const comentarioguardado = document.getElementById('ResultadoDComentariosProgramacion');
const cantDeComentarios = document.getElementById('cantDeComentariosProgramacion');
