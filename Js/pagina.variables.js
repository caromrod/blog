...
const btnguardar = document.getElementById('btnguardarVariables');
const comentarioguardado = document.getElementById('ResultadoDComentariosVariables');
const cantDeComentarios = document.getElementById('cantDeComentariosVariables');
