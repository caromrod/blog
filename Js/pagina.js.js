...
const btnguardar = document.getElementById('btnguardarJs');
const comentarioguardado = document.getElementById('ResultadoDComentariosJs');
const cantDeComentarios = document.getElementById('cantDeComentariosJs');
