...
const btnguardar = document.getElementById('btnguardarJson');
const comentarioguardado = document.getElementById('ResultadoDComentariosJson');
const cantDeComentarios = document.getElementById('cantDeComentariosJson');
